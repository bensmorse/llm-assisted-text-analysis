...
write_csv(result, file = "data\\car_reviews_coded_sample1.csv")
...
Having run the data, we now have a fully-coded corpus:

```{r}
#| echo: false
#| warning: false

df.coded <- read_csv("data\\car_reviews_coded_sample1.csv")
glimpse(df.coded)
