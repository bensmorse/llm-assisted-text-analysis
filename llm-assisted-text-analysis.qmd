...
Companies often have access to unstructured textual data containing insights into consumer preferences and behavior (e.g., customer reviews, feedback surveys, support tickets, or other product feedback channels). Historically, quantifying and analyzing these data has been challenging because traditional natural language processing methods are complex, opaque, and not always insightful. The advent of LLMs, however, has dramatically simplified the process of analyzing unstructured text and improved the quality of the resulting output.

This page provides a demonstration of the process by which a user can use LLMs to code and quantify unstructured textual data. The process involves three steps:

1. Define the codes (variables) to be applied to the data as prompts for the LLM.
...
4. Summarize & analyze the resulting quantitative data. 
